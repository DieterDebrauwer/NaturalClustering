...
#In this script we consider Expected shortfall for misspecification 2 from the supplementary material
...
group2=0.5
group3=0.5
correlations=c(group1,group1,c(0.5,0.5,0.5,0.5,0.5),
...
for (j in 1:500){
  ...
  Opt3RepresentativesES[j]=ESRepresentativesEstimate
}
