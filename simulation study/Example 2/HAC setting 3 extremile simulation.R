...
stopCluster(cl_outer)
#save(weightEstimateMatrixOpt1,file="simulationStudyHACextremilesExtraOpt1SampleSize50.RData")
...
weightEstimateMatrixOpt2 <- foreach(j = 1:500, .combine = rbind, .packages = c("HAC", "copula", "stats")) %dopar% {
  ...
  ESOpt2 <- apply_Extr(0.95, weight_matrix, GiantSampleMatrix)
...
# save(weightEstimateMatrix,weightEstimateMatrixOpt1,weightEstimateMatrixOpt2,weightEstimateMatrixOpt3Representative,
#      weightEstimateMatrixOpt4,weightEstimateMatrixOpt5,
#      file="simulationHACsetting3ExtremileSampleSize50.RData")
# 
...
setwd("I:/clusters topic/HAC/simulation study/HAC setting 3/extremile")
load("simulationHACsetting3ExtremileSampleSize400.RData")

trueExtrsingle=1.634145
trueWeightSingle=c(0.01,0.40,0.53,0.06)

trueExtrOpt1=1.624993
trueWeightOpt1=c(0.0041,0.4059,0.5664,0.0236)

trueExtrOpt2=1.671036
trueWeightOpt2=c(0.0029,0.2871,0.6816,0.0284)

trueExtrOpt3Representative=1.619796
trueWeightOpt3Representative=c(0,0.41,0.59,0) 

trueExtrOpt4=1.964674
trueWeightOpt4=c(0.145,0.145,0.355,0.355)

trueExtrOpt5=1.653633
trueWeightOpt5=c(0.005,0.495,0.480,0.020) 
