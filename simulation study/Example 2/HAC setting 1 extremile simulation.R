...
toc()
#save(weightEstimateMatrix, file="simulationStudyHACextremile14SampleSize400.Rdata")
...
#save(weightEstimateMatrixOpt1,weightEstimateMatrixOpt2,weightEstimateMatrixOpt3Representative,weightEstimateMatrixOpt4,weightEstimateMatrixOpt5,file="simulationStudyHACextremile14SampleSize400Opt1To5.Rdata")
...
trueWeightSingle=c(0.09,0.32,0.29,0.30)

trueExtrOpt1=1.5903
trueWeightOpt1=c(0.4851,0.0049,0.2550,0.2550)

trueExtrOpt2=1.596338
trueWeightOpt2=c(0.4356,0.0044,0.2800,0.2800)

trueExtrOpt3Representative=1.633811 
trueWeightOpt3Representative=c(0.51,0,0.49,0) 
