...
#In this script we go over a first coarse grid and optimize within each cluster (so stage 1)
...
# Generate combinations
combinations <- generate_combinations(numeric(0), rep(1, 4), 1)
combinations <- do.call(rbind, combinations)
combinations <- as.matrix(combinations)
coarseGrid=combinations
dim(coarseGrid)
